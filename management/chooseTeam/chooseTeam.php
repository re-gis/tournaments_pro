...
if (isset($_POST['myInput'])) {
  ...
  setcookie('selected', $selected, time() + 3600, '/');
}
?>
      ...
      <div class="choose-lay">
        ...
        <div class="choose-lay-btn">
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" style="display: flex; gap: 10%;">
            <button class="save-btn" type="submit" value="Save" name="save"><a style="text-decoration: none; color: white" href="../management_menu/team/yourTeam.php">Save</a></button>
